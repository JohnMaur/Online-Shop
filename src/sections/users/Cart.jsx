...
//     try {
//       await axios.put(`http://localhost:3000/api/update-cart/${productId}`, {
//         username,
//         productId,
//         quantity: newQuantity,
//       });
...
//         axios.delete(`http://localhost:3000/api/delete-cart/${productId}`, {
//           data: { username },
//         })
//       ));
...
//           {/* Order Summary */}
//           <div className='w-1/3 bg-white p-4 rounded-lg border border-gray-300 h-fit'>
//             <h2 className='font-bold text-2xl mb-4'>Order Summary</h2>
//             <div className='flex justify-between'>
//               <p>Items:</p>
//               <p>₱{totalPrice}</p>
  ...
  return (
    <div className={`flex flex-row-reverse max-md:flex-row w-full`}>
      <div className='flex flex-col flex-1 h-screen'>
        ...
        <div className={`flex flex-1 max-md:flex-col md:p-4 md:space-x-4 overflow-auto mt-14 bg-[#EFEFEF]`}>
